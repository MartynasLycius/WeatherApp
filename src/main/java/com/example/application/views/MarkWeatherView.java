...
public class MarkWeatherView extends VerticalLayout {
	...
	public MarkWeatherView(DailyWeatherService service, HourlyWeatherService hourService) {
	...
	/**
	 * Marked Location weather report view.
	 *
	 * 
	 */
	...
	public Component GridDataProvider(HourlyWeatherService hourService) {
		...
		grid.addColumn(DailyWeather::getCity_name).setHeader("City Name");
		...
		GridListDataView<DailyWeather> dataView = grid.setItems(service.getMarkedDailyForecast());
		grid.setPageSize(10);
