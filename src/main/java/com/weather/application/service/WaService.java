...
public class WaService {
    ...
    public GeoCode[] getGeoCodeResult(String cityName){
        try{
            ...
            String message = String.format("An Exception occurred while calling getGeoCodeResult() %s", e.getMessage());
    ...
    public HourlyForecast getHourlyForecast(Double latitude, Double longitude, String startDate, String endDate){
        try {
            ...
            String message = String.format("An Exception occurred while calling getHourlyForecast() %s", e.getMessage());
            LOGGER.log(Level.SEVERE, message);
            throw e;
        }
    }
    ...
    public DailyForecast getDailyForecast(Double latitude, Double longitude){
        try {
            ...
            String message = String.format("An Exception occurred while calling getDailyForecast() %s", e.getMessage());
            LOGGER.log(Level.SEVERE, message);
            throw e;
        }
    }
